...
<x-admin.breadcrumb singleName='{{awtTrans("شيفت")}}' deletebutton="true" addbutton="true" >
...
@section('content')
                        ...
                        <tr class="delete_row_{{$row->id}}">
                            ...
                            <td>
                                <x-admin.edit-button>
                                    <x-slot name="data">
                                            data-id       = '{{$row->id}}'
                                            data-route    = '{{route('admin.shifts.update' , [$row->id])}}'
                                ...
                                <x-admin.delete route="{{route('admin.shifts.delete' , [$row->id])}}" />
                            </td>
                        </tr>
                    @endforeach
                </x-slot>
 ...
 <!-- add model -->
    <x-admin.AddModel route='{{route("admin.shifts.store")}}' singleName='{{awtTrans("شيفت")}}' >
        <x-slot name="inputs">
           <div class="col-12">
            ...
            <div class="col-sm-12"> 
                <div class="form-group">
                    ...
                    <div class="controls">
                        <textarea name="description" class="form-control" id="" cols="30" required rows="10" data-validation-required-message="{{awtTrans('الحقل مطلوب')}}"></textarea>
                    </div>
                </div>
            </div>
 ...
 <!-- edit model -->
    <x-admin.edit-model singleName='{{awtTrans("شيفت")}}' >
        <x-slot name="inputs">
          <div class="col-sm-12">  
                <div class="imgMontg">
                    <div class="dropBox">
 ...
 <!-- show model -->
    <x-admin.show-model  singleName='{{awtTrans("شيفت")}}' >
        <x-slot name="inputs">
          <div class="col-sm-12">  
                <div class="imgMontg">
                    <div class="dropBox">
...
{{-- delete all model  --}}
    <x-admin.delete-all route="{{route('admin.shifts.deleteAll')}}" />
{{-- #delete all model  --}}
